...
class Login(tk.Tk):
    ...
    def __init__(self):
        ...
        self.logo = utl.leer_imagen(r"C:\Users\daniel\Downloads\LoginAppPart2 (5)\LoginAppPart2\imagenes\logo.png", (300, 100))
        self.user = utl.leer_imagen(r"C:\Users\daniel\Downloads\LoginAppPart2 (5)\LoginAppPart2\imagenes\login.png", (64, 64))
