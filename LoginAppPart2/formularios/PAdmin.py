...
class PAdmin(tk.Tk):
    def __init__(self, name="", username="", email=""):
        ...
        self.crear_menu()
        self.crear_usuario_info()
        self.crear_area_principal()

    def crear_menu(self):
        menubar = tk.Menu(self)
        menuuser = tk.Menu(menubar, tearoff=0)
        menuuser.add_command(label="Administración de Usuarios", command=self.main_usuarios)
        menubar.add_cascade(label="Usuarios", menu=menuuser)

        menuuser = tk.Menu(menubar, tearoff=0)
        menuuser.add_command(label="Administración de Clientes", command=self.main_clientes)
        menubar.add_cascade(label="Clientes", menu=menuuser)

        menuuser = tk.Menu(menubar, tearoff=0)
        menuuser.add_command(label="Administración de Categorías", command=self.main_categorias)
        menubar.add_cascade(label="Categorías", menu=menuuser)

        menuuser = tk.Menu(menubar, tearoff=0)
        menuuser.add_command(label="Administración de Productos", command=self.main_productos)
        menubar.add_cascade(label="Productos", menu=menuuser)

        menuuser = tk.Menu(menubar, tearoff=0)
        menuuser.add_command(label="Administración de Ventas", command=self.main_ventas)
        menubar.add_cascade(label="Ventas", menu=menuuser)

        self.config(menu=menubar)

    def crear_usuario_info(self):
        ...
        self.userimg = self.leer_imagen(r"C:\Users\daniel\Downloads\LoginAppPart2 (5)\LoginAppPart2\imagenes\userinfo.png", (128, 128))
        self.imgfacebook = self.leer_imagen(r"C:\Users\daniel\Downloads\LoginAppPart2 (5)\LoginAppPart2\imagenes\face.png", (48, 48))
        self.imglinkedin = self.leer_imagen(r"C:\Users\daniel\Downloads\LoginAppPart2 (5)\LoginAppPart2\imagenes\linkedin.png", (48, 48))
        self.imgwebsite = self.leer_imagen(r"C:\Users\daniel\Downloads\LoginAppPart2 (5)\LoginAppPart2\imagenes\website.png", (48, 48))
        self.imglogout = self.leer_imagen(r"C:\Users\daniel\Downloads\LoginAppPart2 (5)\LoginAppPart2\imagenes\logout.png", (48, 48))
    ...
    def crear_area_principal(self):
        ...
        tk.Label(self.frame_dynamic, text="Frame Dinámico", font=('Arial', 20)).pack(padx=20, pady=4)
